...
/// <summary>
/// Seeds a set of monitored URLs on first run so the dashboard has data to display. Includes
/// deterministic failures (404, bad DNS, connection refused) to exercise the error states.
/// </summary>
